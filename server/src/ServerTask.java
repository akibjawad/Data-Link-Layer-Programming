            ...
            while (true)
            {
                ...
                if ((connectionUtilities.read().toString()).equals("y")) {
                    ...
                    if (ClientList.containsKey(RecepientId)) {
                        ...
                        try
                        {
                            PrintWriter output=new PrintWriter("server/output.txt");
                            for (int i = 0; i < chunkCount; i++)
                            {
                                ...
                                */
                                ...
                                if(random<0.9)
                                {
                                    ...
                                    if(i==89)
                                    {
                                        output.println(chunk.data.length+ " bytes written in data array chunk no "+i);
                                        output.println(BitSet.valueOf(chunk.data));
                                    }
                                    output.println(chunk.finalData.length+ " bytes written in final data chunk no "+i);
